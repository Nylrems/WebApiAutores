...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        [HttpGet("/listadoDeComentarios", Name = "obtenerTodosLosComentariosLibros")] //listado

        public async Task<List<ComentarioDTO>> Get([FromQuery] PaginacionDTO paginacionDTO)
        {
            var queryable = context.Comentarios.AsQueryable();
            await HttpContext.InsertarParametrosPaginacionEnCabecera(queryable);
            var comentarios = await queryable.OrderBy(comentario => comentario.Id).Paginar(paginacionDTO).ToListAsync();
            return mapper.Map<List<ComentarioDTO>>(comentarios);
        ...
        [HttpGet("libroID/{id:int}", Name = "obtenerComentario")]
